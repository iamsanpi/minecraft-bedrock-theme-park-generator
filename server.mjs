...
async function writeBedrockPack(config) {
  ...
  await writeFile(
    ...
    [
      ...
      "Important: importing only installs the behavior pack. It does not build the map by itself.",
      "",
      "After import:",
      "1. Open Minecraft Bedrock.",
      "2. Click Play -> Create New -> Create New World.",
      "3. Set the world to Creative mode.",
      "4. Turn Cheats on.",
      "5. Open Behavior Packs, find this imported pack under Available, and click Activate.",
      "6. Create the world.",
      "7. Stand where the center of the theme park should be.",
      "",
      "Run:",
      "/function build",
      "/function start",
